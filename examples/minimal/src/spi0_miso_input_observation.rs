...
#[cfg(any(feature = "spi0-miso-guarded-input-bias", feature = "spi0-timed-peer-zero-irq-proof", feature = "spi0-low-high-irq-rearm-proof"))]
...
#[cfg(all(target_arch = "arm", any(feature = "spi0-miso-guarded-input-bias", feature = "spi0-timed-peer-zero-irq-proof", feature = "spi0-low-high-irq-rearm-proof")))]
#[inline(never)]
