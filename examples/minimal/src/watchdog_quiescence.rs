...
pub const ACK_MAGIC: u32 = if cfg!(feature = "freertos-r3-watchdog-warm-guard") { u32::from_le_bytes(*b"QA09") }
else if cfg!(feature = "freertos-r3-watchdog-kernel-restart") { u32::from_le_bytes(*b"QA08") }
...
pub const fn ack_words() -> [u32; 8] {
    let version = if cfg!(feature = "freertos-r3-watchdog-warm-guard") { 9 }
