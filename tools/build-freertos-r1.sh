...
case "$feature" in freertos-r1|freertos-r1-fault|freertos-r1-panic|freertos-r1-assert|freertos-r1-timer-irq|freertos-r1-periodic-200us|freertos-r2-spi|freertos-r2-spi-lifecycle|freertos-r2-spi-cancel-window|freertos-r2-i2c-nack|freertos-r2-i2c-peer|freertos-r2-i2c-cancel-window|freertos-r2-uart|freertos-r2-mixed) ;; *) exit 2 ;; esac
mkdir -p "$out"
...
if [[ "$feature" == freertos-r2-spi-lifecycle || "$feature" == freertos-r2-spi-cancel-window || "$feature" == freertos-r2-i2c-nack || "$feature" == freertos-r2-i2c-peer || "$feature" == freertos-r2-i2c-cancel-window || "$feature" == freertos-r2-uart || "$feature" == freertos-r2-mixed ]]; then
    export CARGO_PROFILE_RELEASE_OPT_LEVEL=s
else
    export CARGO_PROFILE_RELEASE_OPT_LEVEL=3
fi
printf 'rust_opt_level=%s\n' "$CARGO_PROFILE_RELEASE_OPT_LEVEL"
if [[ "$feature" == freertos-r2-mixed || "$feature" == freertos-r2-i2c-cancel-window ]]; then
