...
case "$feature" in freertos-r1|freertos-r1-fault|freertos-r1-panic|freertos-r1-timer-irq|freertos-r2-spi|freertos-r2-spi-lifecycle|freertos-r2-i2c-nack|freertos-r2-i2c-peer|freertos-r2-uart) ;; *) exit 2 ;; esac
mkdir -p "$out"
...
if [[ "$feature" == freertos-r2-spi-lifecycle || "$feature" == freertos-r2-i2c-nack || "$feature" == freertos-r2-i2c-peer || "$feature" == freertos-r2-uart ]]; then
