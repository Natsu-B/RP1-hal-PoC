...
if [[ "$feature" == freertos-r3-reset-entry-selftest || "$feature" == freertos-r3-watchdog-arm-receipt || "$feature" == freertos-r3-watchdog-quiescence || "$feature" == freertos-r3-watchdog-postack || "$feature" == freertos-r3-watchdog-late-disable ]]; then
    ...
    if [[ "$feature" == freertos-r3-reset-entry-selftest ]]; then
        model_flags+=(--cfg 'feature="freertos-r3-reset-entry-selftest"')
    ...
    if [[ "$feature" == freertos-r3-reset-entry-selftest || "$feature" == freertos-r3-watchdog-quiescence || "$feature" == freertos-r3-watchdog-postack || "$feature" == freertos-r3-watchdog-late-disable ]]; then
    ...
    if [[ "$feature" == freertos-r3-watchdog-postack || "$feature" == freertos-r3-watchdog-late-disable ]]; then
