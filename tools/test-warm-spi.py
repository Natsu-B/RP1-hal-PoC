...
def reject(ev):
    ...
    else:raise AssertionError('invalid AW frame accepted')
for reason in (1,3):
...
for code in (0x45,0x55,0x56,0x66,0x67,0x69,0xff):reject(trace(0xe,code,16_777_215))
...
print(f'PASS: AW F/E {positive} positives/{negative} refusals plus unchanged WDT9 regressions; NOT HW')
