#!/usr/bin/env python3
"""Selected AU warm UART reviewed image identity + existing ELF/probe checks, NOT HW proof."""
...
if __name__=='__main__':
    ...
    print(json.dumps(dict(classification='BUILD',status='PASS',elf_sha256=PIN,
        ...
        boundary='Exact warm UART compiler image manually reviewed; no generalized semantic verifier. Cold watchdog then fresh warm UART owner; 2 real IRQ exchanges and >=32-word warm stack margin gate D. Hardware OPEN; no PCIe recovery, autonomous feeding or full R3 claim.'),indent=2))
